...
const Projets = () => {
	...
	<Container>
		...
		<Section>
		<ProjetGridItem id="github-cli" title="StarCount CLI" thumbnail={thumbStar}
		>
		Interface pour ligne de commande (Typer, Python) intéragissant avec	Github.
		Disponible sur pypi (CI/CD github actions). Modifier sa description
		(Github API) et/ou son statut utilisateur (GraphQl).
		</ProjetGridItem>
		</Section>

		<ProjetGridItem id="dashboard" title="Dashboard Streamlit"
		thumbnail={thumbDash}>
