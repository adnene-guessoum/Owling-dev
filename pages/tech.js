...
import { GridItem, TechStackGridItem } from '../components/grid-item'
...
const Tech = () => (
	...
	j&apos;ai surtout	une expérience en analyse quantitative/analyse de données.
	J&apos;ai appris, ces derniers mois, à apprécier le code et la production
	de projets et d&apos;applications web. Mon objectif est donc d&apos;en faire
	une véritable carrière. Dans cette perspective,
	je travaille régulièrement sur différents projets pour intégrer de nouveaux
	concepts, bonnes pratiques de développement et outils à mes compétences
	techniques. 
	Espérons que cela soit convaincant ! 
	</Paragraph>
	...
	<span>
	Je sépare donc ici chacune des technologies/outils présentés en deux catégories:
	</span>
	...
	2) Ceux que j&apos;ai déja utilisé dans au moins un projet arrivé à son terme (déploiement ou dashboard/analyse)
	</ListItem>
	</List>

	<span> La plupart de ces projets sont disponibles dans la section portfolio
	du site : </span>
	...
	<SimpleGrid columns={[1, 1, 4]} spacing={4} bg='#03fcc64D' borderRadius='lg'
	alignItem="center" p={2} pl={10} mb={3}>
...
<TechStackGridItem 
	...
	<SimpleGrid columns={[1, 1, 4]} spacing={4} bg='#b434eb4D' borderRadius='lg'
	alignItem="center" p={2} pl={10}>
	...
	<SimpleGrid columns={[1, 1, 4]} spacing={4} bg='#03fcc64D' borderRadius='lg'
	alignItem="center" p={2} pl={10} mb={4}>
